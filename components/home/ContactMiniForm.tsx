  ...
  if (submitted) {
    return (
      <div className="bg-white/5 border border-white/10 p-10 text-center">
        ...
        <h3 className="font-headline font-bold text-white text-xl mb-2">Message received.</h3>
        <p className="text-white/60 font-body">A VTM specialist will reach out within 1 business day.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        >
          <option value="" className="bg-vtm-dark">Select a machine...</option>
      ...
      <div>
        ...
        <textarea
          ...
          name="message"
          rows={3}
          placeholder="Tell us about your shop and what you're looking to achieve..."
