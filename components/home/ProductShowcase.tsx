...
const FABRICATION: FabProduct[] = [
  {
    ...
    models: [
      { name: "A Series", image: "/images/SHEET/EA series/main 3015  (1).webp", badge: "Most Accessible",    subtitle: "1.5–3 kW entry-level sheet laser with solid accuracy and a compact footprint." },
      { name: "B Series",  image: "/images/SHEET/B Series/0 main.webp",           badge: "Most Popular",       subtitle: "2–12 kW workhorse for mid-volume shops cutting carbon steel, stainless and aluminum." },
      { name: "FE Series", image: "/images/fiber-laser-feature-04-exchange-table.webp", badge: "Highest Throughput", subtitle: "3–12 kW dual exchange-table design for near-zero downtime production." },
  ...
  },
  {
    ...
    models: [
      { name: "VTM-T",  image: "/images/tube-t-1.webp",  badge: "Standard",      subtitle: "Round tube, square and rectangular profile cutting up to 220 mm diameter." },
      { name: "VTM-MT", image: "/images/tube-mt-1.webp", badge: "Multi-Profile", subtitle: "Handles round, square, rectangular, angle iron, channel and H-beam in one chuck." },
      { name: "VTM-AT", image: "/images/tube-at-1.webp", badge: "Auto Chuck",    subtitle: "Heavy-duty automatic chuck for large-diameter and heavy structural profiles." },
    ],
  },
  {
    key: "sheetTubeCombo",
  ...
  },
  {
    ...
    models: [
      { name: "CNC Press Brake", image: "/images/cnc-press-brake-hero.webp",                badge: "CNC Control",   subtitle: "Full-range CNC press brakes from 40 to 300+ tons with back-gauge and crowning." },
  ...
  },
  {
    ...
    models: [
      { name: "Multi-Station",  image: "/images/ironworker-feature-01-stations.webp", badge: "Multi-Station",  subtitle: "Punch, shear, notch and bend structural steel at multiple simultaneous stations." },
      { name: "Punching",       image: "/images/ironworker-feature-02-punching.webp", badge: "Punching",       subtitle: "Clean punch holes in flat bar, angle and plate with interchangeable tooling." },
      { name: "Notching",       image: "/images/ironworker-feature-03-notching.webp", badge: "Notching",       subtitle: "Angle iron notching for tight-fit structural frames without grinding." },
      { name: "Flat Bar Shear", image: "/images/ironworker-feature-04-flatbar.webp",  badge: "Flat Bar Shear", subtitle: "Straight shear cuts on flat bar stock with minimal burr." },
    ],
  },
];
...
const FABRICATION_ES: FabProduct[] = [
  {
    ...
    href: "/fabrication/fiber-laser-cutting-machine",
    models: [
      { name: "Serie A", image: "/images/SHEET/EA series/main 3015  (1).webp", badge: "Más Accesible",       subtitle: "Láser de chapa de entrada 1.5–3 kW con precisión sólida y huella compacta." },
      { name: "Serie B",  image: "/images/SHEET/B Series/0 main.webp",           badge: "Más Popular",         subtitle: "Potencia de 2–12 kW para talleres de volumen medio que cortan acero, inoxidable y aluminio." },
      { name: "Serie FE", image: "/images/fiber-laser-feature-04-exchange-table.webp", badge: "Mayor Rendimiento", subtitle: "Mesa de intercambio dual de 3–12 kW para producción con tiempo de inactividad casi nulo." },
  ...
  },
  {
    ...
    href: "/fabrication/fiber-laser-tube-cutting-machine",
    models: [
      { name: "VTM-T",  image: "/images/tube-t-1.webp",  badge: "Estándar",         subtitle: "Corte de tubo redondo, cuadrado y rectangular hasta 220 mm de diámetro." },
      { name: "VTM-MT", image: "/images/tube-mt-1.webp", badge: "Multi-Perfil",    subtitle: "Maneja tubo redondo, cuadrado, rectangular, hierro angular, canal y viga H en un solo chuck." },
      { name: "VTM-AT", image: "/images/tube-at-1.webp", badge: "Chuck Automático", subtitle: "Chuck automático de uso intensivo para perfiles estructurales de gran diámetro y peso." },
    ],
  },
  {
    key: "sheetTubeCombo",
    href: "/fabrication/sheet-tube-laser-cutting-machine",
    models: [
      { name: "VTM-ST 3015", image: "/images/sheet-tube-combo-hero.webp",                badge: "Formato 5×10",   subtitle: "Cambia entre modo chapa 5×10 y modo tubo sin cambios de herramientas." },
  ...
  },
  {
    ...
    models: [
      ...
      { name: "Corte",              image: "/images/4in1-laser-feature-02-cutting.webp",  badge: "Corte Láser",          subtitle: "Cabezal de corte láser portátil para recortes en sitio y procesamiento de chapa." },
  ...
  },
  {
    ...
    href: "/fabrication/cnc-press-brake",
    models: [
      { name: "Plegadora CNC", image: "/images/cnc-press-brake-hero.webp",                badge: "Control CNC",         subtitle: "Prensas plegadoras CNC de 40 a 300+ toneladas con retroceso y coronamiento automático." },
  ...
  },
  {
    ...
    href: "/fabrication/ironworker",
    models: [
      { name: "Multi-Estación",    image: "/images/ironworker-feature-01-stations.webp", badge: "Multi-Estación",    subtitle: "Punzonar, cizallar, entallar y doblar acero estructural en múltiples estaciones simultáneas." },
      { name: "Punzonado",         image: "/images/ironworker-feature-02-punching.webp", badge: "Punzonado",         subtitle: "Agujeros limpios en barra plana, angular y placa con herramientas intercambiables." },
      { name: "Entallado",         image: "/images/ironworker-feature-03-notching.webp", badge: "Entallado",         subtitle: "Entallado de hierro angular para marcos estructurales de ajuste preciso sin esmerilado." },
      { name: "Cizalla Barra Plana", image: "/images/ironworker-feature-04-flatbar.webp", badge: "Cizalla Barra Plana", subtitle: "Cortes rectos en barra plana con mínima rebaba." },
    ],
  },
];

const AUTOMATION = [
  { key: "cobot",      href: "/automation/collaborative-welding-arm",  image: "/images/cobot-welding-hero-2.webp" },
  { key: "industrial", href: "/automation/industrial-welding-arm",      image: "/images/industrial-welding-arm-hero.webp" },
];
