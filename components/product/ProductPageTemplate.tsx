          ...
          __html: JSON.stringify([
            {
              ...
              offers: {
                ...
                priceCurrency: "USD",
                seller: { "@type": "Organization", name: "VTM Tech Solutions" },
              },
            },
            {
              "@context": "https://schema.org",
              "@type": "BreadcrumbList",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "Home", item: "https://vtmtechsolutions.com" },
                {
                  "@type": "ListItem",
                  position: 2,
                  name: category,
                  item: `https://vtmtechsolutions.com/${category.toLowerCase()}`,
                },
