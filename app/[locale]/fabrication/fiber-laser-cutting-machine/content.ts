...
const en: FiberLaserContent = {
  hero: {
    ...
    subheadline: "1.5 kW to 30 kW. ±0.05 mm accuracy. Bed sizes from 4′×4′ to 8′×20′. Raycus source, HIWIN rails, CypCut CNC — full installation and US support included.",
  ...
  features: [
    ...
    { number: "02", headline: "±0.05mm Accuracy on HIWIN Rails", body: "HIWIN linear guide rails (20–35 series depending on model) and Fuji bus servo drives deliver ±0.05mm positioning accuracy on every axis. Closed-loop feedback, no belt drives, no compromise — the same components used in CNC machining centers.", spec: { label: "Positioning", value: "±0.05 mm" } },
  ...
  stickyBar: { machineName: "Fiber Laser Cutting Machine", cta: "Get a Quote" },
  form: {
...
const es: FiberLaserContent = {
  hero: {
    ...
    subheadline: "1.5 kW a 30 kW. Precisión ±0.05 mm. Mesas de 4′×4′ a 8′×20′. Fuente Raycus, guías HIWIN, CNC CypCut — instalación completa y soporte en EE.UU. incluidos.",
  ...
  features: [
    ...
    { number: "02", headline: "Precisión ±0.05mm en Guías HIWIN", body: "Las guías lineales HIWIN (series 20–35 según el modelo) y los servomotores de bus Fuji ofrecen una precisión de posicionamiento de ±0.05mm en cada eje. Retroalimentación de lazo cerrado, sin correas, sin compromisos — los mismos componentes utilizados en centros de mecanizado CNC.", spec: { label: "Posicionamiento", value: "±0.05 mm" } },
  ...
  stickyBar: { machineName: "Máquina de Corte Láser de Fibra", cta: "Solicitar Cotización" },
  form: {
