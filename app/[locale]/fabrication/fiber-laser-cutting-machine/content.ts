...
const es: FiberLaserContent = {
  ...
  subheadline: "1.5 kW a 120 kW. Precisión ±0.03 mm — instalación completa, capacitación y servicio técnico en Chile incluidos.",
  ...
  features: [
    ...
    { number: "04", headline: "Mesas para formatos de plancha en Chile", body: "Los tamaños de mesa cubren los formatos de plancha más usados en fabricación metálica local, incluyendo 3000×1500, 4000×2000, 6000×1500, 6000×2000 y 6000×2500 mm. Esto permite trabajar desde producción estándar hasta planchas de mayor formato, reduciendo recortes, manipulación y tiempos muertos.", spec: { label: "Mesa Máx.", value: "6000×2500 mm" } },
    { number: "05", headline: "Mesa de Intercambio Estándar en Serie FE", body: "Los modelos de la serie FE incluyen mesa de intercambio de doble paleta como estándar — no como accesorio adicional costoso. Cargue el siguiente corte mientras la máquina procesa la plancha actual. Cambio de pieza a pieza en menos de 15 segundos. Sin tiempo de inactividad, sin operadores esperando en la máquina.", spec: { label: "Cambio de Paleta", value: "< 15 seg" } },
  ],
  enclosed: {
    sectionLabel: "Opción Encapsulada",
    headline: "¿Necesita Clase de Seguridad Láser 1?",
    subheadline: "Los modelos cerrados VTM-PE y VTM-SE agregan protección perimetral y extracción de humos para operar con mayor seguridad. La VTM-PE suma doble mesa de intercambio rápido, mientras la VTM-SE ofrece una solución cerrada de mesa simple, compacta y flexible.",
    features: [
      { number: "01", headline: "Cabina Cerrada — Protección Total 360°", body: "La cabina cerrada de los modelos VTM-PE y VTM-SE ayuda a aislar el proceso de corte, reduciendo la exposición del operador a radiación láser, humos y partículas. Esto permite una operación más segura, limpia y controlada dentro del taller.", spec: { label: "Protección", value: "360°" } },
      ...
      { number: "05", headline: "VTM-PE vs. VTM-SE — Doble Mesa o Mesa Simple Cerrada", body: "VTM-PE es una cortadora láser de fibra cerrada con doble mesa de intercambio rápido, disponible en formatos 3015, 6015, 4020, 6025 y 12025, con potencias de 3 a 50 kW según configuración. VTM-SE es una solución cerrada de mesa simple, disponible en formatos 3015 y 1315, con potencias de 1.5, 3 y 6 kW para talleres que buscan alta seguridad, flexibilidad y diseño compacto.", spec: { label: "Variantes", value: "PE doble mesa / SE mesa simple" } },
    ],
  },
  ...
  configure: {
    ...
    options: [
      ...
      { label: "Tamaño de Mesa", options: ["3000×1500 mm (3015)", "4000×2000 mm (4020)", "6000×1500 mm (6015)", "6000×2000 mm (6020)", "6000×2500 mm (6025)"], note: "Haga coincidir el tamaño de mesa con el formato de plancha que usa normalmente en su taller para minimizar recortes y tiempo de manipulación." },
      ...
      { label: "Encapsulado", options: ["Bastidor Abierto (estándar)", "VTM-PE — cerrada con doble mesa de intercambio", "VTM-SE — mesa simple cerrada compacta"], note: "Los modelos cerrados incorporan protección perimetral y extracción de humos. VTM-PE agrega doble mesa para ahorrar tiempo en carga y descarga; VTM-SE ofrece alta seguridad, operación flexible y diseño compacto." },
    ],
  },
  compare: {
    ...
    rows: [
      ...
      { feature: "Velocidad de corte (plancha fina <3mm)", fiber: "3× más rápido", co2: "Base" },
  ...
  faq: {
    ...
    items: [
      ...
      { question: "¿Cuál es la diferencia entre VTM-PE y VTM-SE?", answer: "VTM-PE es una máquina cerrada con doble mesa de intercambio rápido, orientada a producción de mayor potencia y menor tiempo muerto entre carga, descarga y corte. VTM-SE es una máquina cerrada de mesa simple, más compacta y flexible, pensada para operación segura con protección 360°, menor exposición a radiación, humos y partículas, y control inalámbrico amigable." },
    ],
  },
  stickyBar: { machineName: "Cortadora Láser de Plancha", cta: "Solicitar Cotización" },
  form: {
