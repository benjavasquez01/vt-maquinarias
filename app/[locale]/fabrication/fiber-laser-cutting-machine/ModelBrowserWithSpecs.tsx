  ...
  fe: {
    ...
    rows: [
      { type: "spec", label: "Working Area",
        ...
        imperial: ["5' × 10'",        "6.6' × 13.1'"] },
      { type: "spec", label: "Laser Power",
        metric:   ["3 / 6 / 12 kW","3 / 6 / 12 kW"],
        imperial: ["3 / 6 / 12 kW","3 / 6 / 12 kW"] },
      { type: "spec", label: "Pallet Change Time",
        metric:   ["< 15 sec","< 15 sec"],
        imperial: ["< 15 sec","< 15 sec"] },
      { type: "spec", label: "Positioning Accuracy",
      ...
      { type: "spec", label: "Voltage",
        ...
        imperial: ["380V 3PH 50/60Hz","380V 3PH 50/60Hz"] },
      { type: "spec", label: "Carbon Steel",
        metric:   ["up to 30 mm",       "up to 30 mm"],
        imperial: ["up to 1-3/16\"",    "up to 1-3/16\""] },
      { type: "spec", label: "Stainless Steel",
        metric:   ["up to 20 mm",  "up to 20 mm"],
        imperial: ["up to 0.79\"", "up to 0.79\""] },
      { type: "spec", label: "Aluminum",
        metric:   ["up to 16 mm",  "up to 16 mm"],
        imperial: ["up to 5/8\"",  "up to 5/8\""] },
    ],
    features: [],
