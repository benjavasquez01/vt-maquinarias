...
const en: ProductPageData = {
  ...
  features: [
    ...
    {
      number: "05",
      headline: "Portable Handheld — Take It to the Part",
      body: "The 50W and 100W configurations ship with a lightweight handheld scan head (under 1.5 kg) and a 10-meter fiber delivery cable. Clean structural welds on an assembled frame, descale pipe sections in the field, or remove coatings from repair areas without moving the workpiece.",
      spec: { label: "Head Weight", value: "< 1.5 kg" },
      imageId: "/images/laser-cleaning-feature-05-portable.webp",
    },
  ],
  specs: [
    ...
    { label: "Pulse Frequency", imperial: "1–4000 kHz", metric: "1–4000 kHz" },
    { label: "Pulse Width", imperial: "2–500 ns", metric: "2–500 ns" },
    { label: "Max Scan Speed", imperial: "0–275 in/s", metric: "0–7 m/s" },
    { label: "Scan Width (adjustable)", imperial: "0.4\"–6\"", metric: "10–150 mm" },
...
const es: ProductPageData = {
  ...
  features: [
    ...
    {
      number: "05",
      headline: "Portátil — Llévelo a la Pieza",
      body: "Las configuraciones de 50W y 100W se envían con un cabezal de escaneo portátil ligero (menos de 1.5 kg) y un cable de fibra de 10 metros. Limpie soldaduras estructurales en un marco ensamblado, descascare secciones de tuberías en el campo o elimine recubrimientos de áreas de reparación sin mover la pieza de trabajo.",
      spec: { label: "Peso del Cabezal", value: "< 1.5 kg" },
      imageId: "/images/laser-cleaning-feature-05-portable.webp",
    },
  ],
  specs: [
