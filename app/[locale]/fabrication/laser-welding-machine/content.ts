...
const en: ProductPageData = {
  ...
  features: [
    ...
    {
      number: "03",
      headline: "5× Faster Than TIG — Feed Speed Up to 10 m/min",
      body: "Wire feed speed up to 10 m/min dramatically outpaces manual TIG. Robotic integration compounds the advantage — consistent speed, no fatigue, and no spatter cleanup between passes. Cycle times that took 20 minutes with TIG routinely drop below 4 minutes.",
      spec: { label: "Feed Speed", value: "0–10 m/min" },
  ...
  specs: [
    { label: "Laser Power Options", imperial: "1500W / 2000W / 3000W", metric: "1500W / 2000W / 3000W" },
    { label: "Laser Source", imperial: "IPG Photonics fiber laser", metric: "IPG Photonics fiber laser" },
    { label: "Wavelength", imperial: "1070 nm", metric: "1070 nm" },
    { label: "Wire Feed Speed", imperial: "0–394 in/min", metric: "0–10 m/min" },
    { label: "Material Thickness Range", imperial: "0.008\"–0.24\"", metric: "0.2–6 mm" },
    { label: "Welding Speed (handheld)", imperial: "up to 157 in/min", metric: "up to 4 m/min" },
    { label: "Welding Speed (robotic)", imperial: "up to 394 in/min", metric: "up to 10 m/min" },
    { label: "Focal Length", imperial: "7.87\"", metric: "200 mm" },
    { label: "Spot Diameter", imperial: "0.004\"–0.024\"", metric: "0.1–0.6 mm" },
    { label: "Shielding Gas", imperial: "Nitrogen or Argon", metric: "Nitrogen or Argon" },
    { label: "Cooling", imperial: "Water-cooled laser head", metric: "Water-cooled laser head" },
    { label: "Fiber Cable Length", imperial: "33 ft (standard)", metric: "10 m (standard)" },
...
const es: ProductPageData = {
  ...
  features: [
    ...
    {
      number: "03",
      headline: "5× Más Rápido que TIG — Velocidad de Avance hasta 10 m/min",
      body: "La velocidad de avance hasta 10 m/min supera drásticamente al TIG manual. La integración robótica multiplica la ventaja — velocidad constante, sin fatiga y sin limpieza de salpicaduras entre pasadas. Tiempos de ciclo que tomaban 20 minutos con TIG caen rutinariamente por debajo de 4 minutos.",
      spec: { label: "Velocidad de Avance", value: "0–10 m/min" },
      imageId: "1565514020179-026b92b84bb6",
    },
    {
      number: "04",
  ...
  specs: [
    { label: "Opciones de Potencia Láser", imperial: "1500W / 2000W / 3000W", metric: "1500W / 2000W / 3000W" },
    { label: "Fuente Láser", imperial: "Láser de fibra IPG Photonics", metric: "Láser de fibra IPG Photonics" },
    { label: "Longitud de Onda", imperial: "1070 nm", metric: "1070 nm" },
    { label: "Velocidad de Alimentación de Alambre", imperial: "0–394 pulg/min", metric: "0–10 m/min" },
    { label: "Rango de Espesor de Material", imperial: "0.008\"–0.24\"", metric: "0.2–6 mm" },
    { label: "Velocidad de Soldadura (portátil)", imperial: "hasta 157 pulg/min", metric: "hasta 4 m/min" },
    { label: "Velocidad de Soldadura (robótica)", imperial: "hasta 394 pulg/min", metric: "hasta 10 m/min" },
    { label: "Longitud Focal", imperial: "7.87\"", metric: "200 mm" },
    { label: "Diámetro del Punto", imperial: "0.004\"–0.024\"", metric: "0.1–0.6 mm" },
    { label: "Gas Protector", imperial: "Nitrógeno o Argón", metric: "Nitrógeno o Argón" },
    { label: "Refrigeración", imperial: "Cabezal láser refrigerado por agua", metric: "Cabezal láser refrigerado por agua" },
    { label: "Longitud del Cable de Fibra", imperial: "33 ft (estándar)", metric: "10 m (estándar)" },
