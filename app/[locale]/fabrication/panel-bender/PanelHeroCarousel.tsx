...
const IMAGES = [
  { src: "/images/vtm-p-1.webp", alt: "Paneladora CNC por succión VTM-P — vista 3/4" },
  { src: "/images/vtm-p-2.webp", alt: "Paneladora CNC por succión VTM-P — vista frontal" },
];

export function PanelHeroCarousel() {
