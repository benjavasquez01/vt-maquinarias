...
const en: FabricationPageContent = {
  ...
  products: [
    { slug: "fiber-laser-cutting-machine", name: "Fiber Laser Sheet Cutting Machine", tag: "Cutting", description: "1.5–30 kW, ±0.05 mm accuracy. Beds from 4′×4′ to 8′×20′. Exchange table on FE series.", imageId: "/images/fiber-laser-hero.webp" },
    { slug: "fiber-laser-tube-cutting-machine", name: "Fiber Laser Tube Cutting Machine", tag: "Tube Cutting", description: "VTM-T / VTM-MT. 1.5–6 kW. Round tube to 220 mm, lengths to 9 m. Round, square, structural profiles.", imageId: "/images/fiber-laser-tube-hero.webp" },
    { slug: "sheet-tube-laser-cutting-machine", name: "Sheet & Tube Combo Laser", tag: "Combo", description: "VTM-ST. Flat sheet and tube on one machine. 3–6 kW, bed to 4020, tube to 180 mm.", imageId: "/images/sheet-tube-combo-hero.webp" },
    { slug: "4-in-1-laser-machine", name: "Laser Welding Machine", tag: "Welding", description: "VTM-4W. Handheld welding, cutting, cleaning, wire-feed. 1.5–3 kW, all common metals.", imageId: "/images/4in1-laser-hero-2.webp" },
    { slug: "laser-cleaning-machine", name: "Laser Cleaning Machine", tag: "Cleaning", description: "50–500W pulsed fiber. Removes rust, coatings, and oxides with no chemicals.", imageId: "/images/laser-cleaning-hero.webp" },
