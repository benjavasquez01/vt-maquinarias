...
const en: FabricationPageContent = {
  ...
  products: [
    { slug: "fiber-laser-cutting-machine", name: "Fiber Laser Cutting Machine", tag: "Cutting", description: "1.5–30 kW, ±0.05 mm accuracy. Beds from 4′×4′ to 8′×20′. Exchange table on FE series.", imageId: "/images/fiber-laser-hero.png" },
...
const es: FabricationPageContent = {
  ...
  products: [
    { slug: "fiber-laser-cutting-machine", name: "Máquina de Corte Láser de Fibra", tag: "Corte", description: "1.5–30 kW, precisión ±0.05 mm. Mesas de 4′×4′ a 8′×20′. Mesa de intercambio en serie FE.", imageId: "/images/fiber-laser-hero.png" },
