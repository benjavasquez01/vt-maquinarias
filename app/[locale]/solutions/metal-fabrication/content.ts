...
const es: MetalFabContent = {
  hero: {
    ...
    headline: "Maestranzas",
    subheadline: "De la plancha en bruto a la pieza terminada — equipos de corte láser, plegado CNC, soldadura y limpieza para maestranzas y talleres metalmecánicos que trabajan con tolerancias ajustadas y alto rendimiento.",
  ...
  machines: [
    { name: "Cortadora Láser de Plancha", href: "/fabrication/fiber-laser-cutting-machine", spec: "3–20 kW · ±0.05mm", tag: "Corte", imageId: "/images/fiber-laser-hero.webp" },
