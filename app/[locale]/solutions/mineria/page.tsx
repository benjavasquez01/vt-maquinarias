...
export const metadata: Metadata = {
  ...
  description:
    "Corte láser, plegado CNC, punzonado, soldadura y limpieza para estructuras, piezas de desgaste y componentes de la gran y mediana minería. Repuestos y soporte en Chile.",
};
