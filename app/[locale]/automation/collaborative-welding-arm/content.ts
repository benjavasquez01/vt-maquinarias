...
const en: CollaborativeArmContent = {
  ...
  related: {
    ...
    items: [
      { name: "Industrial Welding Arm", href: "/automation/industrial-welding-arm", tag: "Automation", imageId: "1518770660439-4636190af475" },
...
const es: CollaborativeArmContent = {
  ...
  related: {
    ...
    items: [
      { name: "Brazo de Soldadura Industrial", href: "/automation/industrial-welding-arm", tag: "Automatización", imageId: "1518770660439-4636190af475" },
