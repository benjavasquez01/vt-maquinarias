...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { path: "/fabrication/shearing-machine/guillotine", priority: 0.9, freq: "monthly" as const },
    { path: "/fabrication/shearing-machine/swing-beam", priority: 0.9, freq: "monthly" as const },
    ...
    { path: "/blog/shearing-machine-guillotine-vs-swing-beam", priority: 0.6, freq: "monthly" as const },
