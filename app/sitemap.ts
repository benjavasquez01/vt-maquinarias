...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? "https://vtmaquinarias.cl";
const LOCALES = ["en", "es"];
...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { path: "/solutions/mineria", priority: 0.7, freq: "monthly" as const },
    { path: "/solutions/equipo-gastronomico", priority: 0.7, freq: "monthly" as const },
